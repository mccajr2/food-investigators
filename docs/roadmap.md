...
|------|-----|--------|-------|---------|
| 1 | pace-insights | active | 2026-07-11 · initial | Parent dashboard: trends on what’s working; gentle suggestions you can ignore |
...
| Id | Branch | Spec |
|----|--------|------|
| pace-insights | `pace-insights` | [active](specs/active/pace-insights.md) |
